export default function Privacy() {
  return (
    <>
      ...
      <p>
        PETWIF(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사
      ...
      <p>
        회사는 이용자에게 회사의 결제 서비스 제공을 위하여 다음과 같은 정보를
        수집합니다.
      </p>
      <ul>
        <li>
      ...
      <p>
        회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우
        이용자의 명시적인 사전동의를 받습니다. 다만, 다음 각호 어느 하나에
        해당하는 경우에는 사전 동의를 받지 않습니다.
      </p>
      <ul>
        <li>
          회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한
      ...
      <p>
        회사는 전항에도 불구하고 수신자가 수신거부의사를 표시하거나 사전 동의를
        철회한 경우에는 영리목적의 광고성 정보를 전송하지 않으며 수신거부 및
        수신동의 철회에 대한 처리 결과를 알립니다.
      </p>
      <p>
      ...
      <p>
        <strong>제18조(개인정보 유출 등에 대한 조치)</strong>
      </p>
      <p>
      ...
      <p>
        <strong>제19조(개인정보 유출 등에 대한 조치의 예외)</strong>
      </p>
      <p>
      ...
      <p>
        다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 회사의 일부 서비스는
        이용에 어려움이 있을 수 있습니다.
      </p>
      ...
      <ul>
        ...
        <li>
          Whale : 웹브라우저 우측 상단의 설정 메뉴 - 개인정보 보호 - 쿠키 및
          기타 사이트 데이터
        </li>
      </ul>

      <p>
        <strong>제22조(권익침해에 대한 구제방법)</strong>
      </p>
      <p>
