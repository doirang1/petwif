...
<p>PETWIF(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.</p>
...
<ul>
    <li>필수 수집 정보: 이메일 주소, 비밀번호, 이름, 닉네임, 생년월일</li>
</ul>

<p><strong>제6조(본인 인증을 위한 정보)</strong></p>
<p>회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.</p>
<ul>
    <li>필수 수집 정보: 이메일 주소</li>
</ul>

<p><strong>제7조(결제 서비스를 위한 정보)</strong></p>
<p>회사는 이용자에게 회사의 결제 서비스 제공을 위하여 다음과 같은 정보를 수집합니다.</p>
<ul>
    <li>필수 수집 정보: 카드번호, 카드비밀번호, 유효기간, 생년월일 6자리(yy/mm/dd), 은행명 및 계좌번호</li>
</ul>
...
<p><strong>제16조(아동의 개인정보보호)</strong></p>
...
<p><strong>제17조(이용자의 의무)</strong></p>
...
<p><strong>제18조(개인정보 유출 등에 대한 조치)</strong></p>
...
<p><strong>제21조(쿠키 설치 허용 지정 방법)</strong></p>
...
<p><strong>제22조(권익침해에 대한 구제방법)</strong></p>
